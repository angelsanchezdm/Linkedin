...
| # | Fecha | Idea (de la keynote) | Formato | Estado |
|---|-------|----------------------|--------|--------|
| 1 | mar 29 sep, 8:30 | Si hacer ya casi no cuesta, lo que cuesta es decidir bien (abre la serie) | Manifiesto | borrador listo (draft-00) |
| 1b | jue 1 oct, 8:30 | Momentum = estado del negocio, no interés del contacto (hotel en temporada alta) | La escena | borrador listo (draft-01) |
| 2 | lun 5 oct, 8:30 | Más rápido ≠ más a tiempo (el agente que agenda al instante a quien dijo "después de temporada") | La frase incómoda | pendiente |
