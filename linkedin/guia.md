...
## 1. A quién seguir y comentar

Activa la campana (🔔) en el perfil de cada uno para recibir un aviso cuando publiquen. Un comentario en la primera hora se ve; con 20 comentarios delante, ya no.

### Evento (prioridad máxima, porque es el público del día 13)

| Quién | Por qué | Qué hacer | Enlace |
|---|---|---|---|
| **Walid Amarir** (cofundador y CEO de WaLead) | Organiza Day One. Su red es exactamente la gente que irá. | Conectar si aún no lo estáis. Comentar TODOS sus posts de Day One. Pedirle la lista de ponentes y los materiales oficiales. | linkedin.com/in/walidamarir |
...
Directores comerciales y CEOs B2B que vayan a Day One. Cómo encontrarlos:
1. Abre los posts de WaLead y de Walid sobre Day One.
2. Mira quién comenta "me apunto", "allí estaré" o similar.
3. Elige 2-5 directores comerciales o CEOs.

Con ellos: seguir y comentar sus posts. Nunca vender en comentarios. El día 13, conversación en persona.

Claude puede sacar esa lista automáticamente leyendo los comentarios con WaLead cuando se reconecte el conector (1 crédito por post).

---

## 2. Rutina diaria (20-30 min)

| Cuándo | Dónde | Qué | Por qué |
|---|---|---|---|
| 8:00-8:20, lunes a viernes | LinkedIn (móvil vale) | Revisar avisos de la campana y comentar 2-3 posts de la lista. Si no sabes qué decir, pega el post a Claude con `/li-comment`. | Los comentarios en posts ajenos son los que hacen que tus posts lleguen a más gente. |
| 8:30, días de post | LinkedIn, "Crear publicación" | Pegar el texto final tal cual. Sin enlaces en el cuerpo; si hay enlace, va en el primer comentario. | LinkedIn penaliza los posts con enlaces externos. |
| 8:30-9:30, días de post | Notificaciones | Responder cada comentario en la primera hora, con frases de verdad, no con "¡gracias!". | La primera hora decide el alcance del resto del día. |
| Al final del día de post | Claude | Pegar el enlace del post y los comentarios → `/li-reply` prepara respuestas a los que falten. | Nadie se queda sin contestar. |
| Viernes, 15 min | Claude | Pegar las estadísticas de la semana → `/li-audit`. | Saber qué funciona antes de seguir. |
...
- **Hoy o mañana:** escribir a Walid (o al contacto de WaLead) y pedirle: agenda y lista de ponentes, hora de tu ponencia, enlace de registro, material gráfico, y si WaLead compartirá tu anuncio.
...
### Semana del 12 oct
- **Lun 12, 8:30 · post 5 (práctico):** una señal pública que cualquiera puede vigilar y la decisión que mejora + "mañana en Day One".
- **Mar 13 · Day One:**
  - Antes de la ponencia: foto del escenario o la acreditación y dos líneas. Nada largo.
  - Después: conectar ese mismo día con quien se acerque, con una nota corta que diga dónde os conocisteis. Apunta nombres y de qué hablasteis.
- **Mié 14, 8:30 · post 6 (resumen):** qué preguntó la gente y qué te llevas. Etiquetar a WaLead y agradecer.
- **15-20 oct:** seguimiento por mensaje privado a quien conociste (`/li-dm`). Claude puede enviarlos desde WaLead con tu visto bueno.
...
| Tarea | Tú | Claude |
|---|---|---|
| Escribir posts | Das el "sí" o dices qué no dirías | Escribe con tu perfil de voz y pasa los comprobadores |
| Publicar | Pegas y publicas | No puede (no hay herramienta y automatizarlo pone en riesgo tu cuenta) |
| Comentar a otros | Pegas el comentario | Lo escribe si le pegas el post (o lo lee con WaLead) |
| Responder comentarios | Pegas respuestas | Las escribe a partir del enlace y los comentarios |
| Mensajes privados | Das visto bueno | Los escribe y puede enviarlos desde WaLead |
| Encontrar asistentes/decisores | - | Lee comentarios de posts de Day One con WaLead |
